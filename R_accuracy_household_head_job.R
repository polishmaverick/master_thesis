...
for (i in 1:14) {
  ...
  for (j in seq_along(data_samples_MCAR)) {
    actual <- data_samples_MCAR[[j]]$household_head_job
    predicted <- imp_rf_data_MCAR[[i]][[j]]$household_head_job
    res_i[j] <- accuracy(actual, predicted)
  }
...
for (i in 1:14) {
  ...
  for (j in seq_along(data_samples_MAR)) {
    actual <- data_samples_MAR[[j]]$household_head_job
    predicted <- imp_rf_data_MAR[[i]][[j]]$household_head_job
    res_i[j] <- accuracy(actual, predicted)
  }
...
for (i in 1:14) {
  ...
  for (j in seq_along(data_samples_MNAR)) {
    actual <- data_samples_MNAR[[j]]$household_head_job
    predicted <- imp_rf_data_MNAR[[i]][[j]]$household_head_job
    res_i[j] <- accuracy(actual, predicted)
  }
...
for (i in 1:14) {
  ...
  for (j in seq_along(data_samples_MCAR)) {
    actual <- data_samples_MCAR[[j]]$household_head_job
    predicted <- imp_mul_data_MCAR[[i]][[j]]$household_head_job
    res_i[j] <- accuracy(actual, predicted)
  }
...
for (i in 1:14) {
  ...
  for (j in seq_along(data_samples_MAR)) {
    actual <- data_samples_MAR[[j]]$household_head_job
    predicted <- imp_mul_data_MAR[[i]][[j]]$household_head_job
    res_i[j] <- accuracy(actual, predicted)
  }
...
for (i in 1:14) {
  ...
  for (j in seq_along(data_samples_MNAR)) {
    actual <- data_samples_MNAR[[j]]$household_head_job
    predicted <- imp_mul_data_MNAR[[i]][[j]]$household_head_job
    res_i[j] <- accuracy(actual, predicted)
  }
